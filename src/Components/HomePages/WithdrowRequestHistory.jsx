...
import { formatDateFunc, formatDateTimenumber, getuserListApi, getWithdrowHistoryApi } from '../Global/GloblalFunction';
...
const WithdrowRequestHistory = () => {
    ...
    const { token, withdrowHistory, allUserData } = useSelector((state) => state);
                                            ...
                                            {filteredData?.map((item, index) => (
                                                <tr key={index} className="border-t border-gray-200 hover:bg-gray-50">
                                                    ...
                                                    <td className="p-3">
                                                        <Link
                                                            to="/userlinks"
                                                            onClick={() => handleShowUserData(item.userid)}
                                                            className="text-[#6540b2]  hover:underline"
                                                        >
                                                            {item.userid || 'N/A'}
                                                        </Link>
                                                    </td>
